...
class td_block_related_posts extends td_block {
    ...
    function render($atts, $content = null) {
        ...
        $buffy .= '<h4 class="td-related-title td-block-title">';
            ...
            //XXX FUTURA $buffy .= '<a id="' . td_global::td_generate_unique_id() . '" class="td-related-right" data-td_filter_value="td_related_more_from_author" data-td_block_id="' . $this->block_uid . '" href="#">' . __td('MORE FROM AUTHOR', TD_THEME_NAME) . '</a>';
        $buffy .= '</h4>';
